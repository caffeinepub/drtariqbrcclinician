      ...
      <div className="mx-auto max-w-4xl space-y-6">
              ...
              <>
                ...
                {emailNotificationsEnabled ? (
                  <Alert className="border-emerald-200 bg-emerald-50">
                    ...
                    <AlertDescription className="text-emerald-700">
                      The system is actively sending email alerts to{" "}
                      <strong>
                        {emailSettings?.recipientEmail ||
                          "drtariqherbal@gmail.com"}
                      </strong>{" "}
                      when new appointments are submitted.
                    </AlertDescription>
                  </Alert>
                ) : (
                  <Alert className="border-amber-200 bg-amber-50">
                    ...
                    <AlertDescription className="text-amber-700">
                      Enable email notifications to receive automatic alerts for
                ...
                <div className="flex items-center justify-between rounded-lg border border-emerald-200 bg-emerald-50 p-4">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Receive instant email alerts when patients book
                      appointments
                    </p>
                  </div>
                  <Switch
                    ...
                    disabled={
                      enableEmailNotifications.isPending ||
                      disableEmailNotifications.isPending
                    }
                  />
                </div>
                ...
                <div className="space-y-3 rounded-lg border border-gray-200 bg-gray-50 p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-semibold ${emailNotificationsEnabled ? "text-green-600" : "text-amber-600"}`}
                      >
                ...
                <div className="space-y-3">
                  ...
                  <div className="rounded-lg border border-gray-200 bg-white p-4 text-sm">
                    ...
                    <div className="space-y-2 text-gray-700">
                      ...
                      <p>
                        <strong>Contact Info:</strong> [Email/Phone]
                      </p>
                      <p>
                        <strong>Preferred Date & Time:</strong> [Date and Time]
                      </p>
                      <p>
                        <strong>Consultation Type:</strong> [Online/Clinic
                        Visit]
                      </p>
                      <p>
                        <strong>Health Concerns:</strong> [Patient's concerns]
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-blue-800">
                      ...
                      <ul className="list-inside list-disc space-y-1">
                        <li>
                          Email notifications are sent immediately when a
                          patient submits an appointment request
                        </li>
                        <li>
                          Emails include all appointment details for quick
                          review
                        </li>
                        <li>
        ...
        <Card className="border-gray-200 bg-gray-50">
          <CardHeader>
            ...
            <CardDescription>
              More configuration options will be available here in future
              updates
            </CardDescription>
          </CardHeader>
        </Card>
